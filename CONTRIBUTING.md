...
The keyword dictionary at `keywords/mi.json` contains draft placeholders. For PyReo to be worthwhile as an educational tool, those words need to be the right words chosen by people who are fluent in te reo Māori and understand the cultural weight of each term.
